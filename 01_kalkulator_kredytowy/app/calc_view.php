...
<section id="formularz">
	<form action="<?php print(_APP_URL);?>/app/calc.php" method="post">
		...
		<label for="months">Ilość miesięcy: </label>
		<select name="months">
			<option value="six">6</option>
			<option value="twelve">12</option>
			<option value="twentyFour">24</option>
			<option value="fourtyEight">48</option>
		</select><br />
		<label for="percent">Oprocentowanie: </label>
		<input id="percent" type="number" name="percent" value="<?php isset($percent) ? print($percent):''; ?>" /> % <br />
